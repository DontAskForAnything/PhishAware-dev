...
const PentagonChart: React.FC<PentagonChartProps> = ({ data}) => {
  ...
  return (
    ...
    <RadarChart cx="50%" cy="50%"  data={data}>
      <PolarGrid  polarRadius={[10*2, 20*2, 30*2, 40*2, 50*2, 60*2, 70*2, 80*2, 90*2,100*2]}  />
      ...
      <Radar name="Goal" dataKey="B" stroke="#8884d8" fill="none" fillOpacity={0.6} isAnimationActive ={false} />
    </RadarChart>
  </ResponsiveContainer>
