  ...
  return (
    <div className=" px-6 pb-6 gap-8 flex flex-col">
      ...
      <div className="  gap-8 flex flex-row justify-between ">
        <div className={`w-52 h-24  gap-1  bg-[#D9D9D9]   justify-center items-center drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)]   flex flex-col rounded-2xl  `}>
          <p className="text-sm font-semibold">Rozpocznij testy</p>
          <Play size={40} />
        </div>
        
                <div className={`w-full  gap-1  bg-[#D9D9D9]   justify-center items-center drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)]   flex flex-col rounded-2xl  `}>
        ...
        <div className={`w-52 h-24  gap-1  bg-[#D9D9D9]   justify-center items-center drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)]   flex flex-col rounded-2xl  `}>
          <p className="text-sm font-semibold">Wskaźnik podatności</p>
           <div
              className="text-center px-6 py-2 rounded-xl text-white bg-[#E2615E]"
      ...
      <div className="  gap-8 flex flex-row justify-between ">
        <div className={`w-full aspect-square  gap-1  bg-[#D9D9D9] p-6  drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)]   flex flex-col rounded-2xl  `}>
          <p className="text-sm font-semibold text-center">Rozpocznij testy</p>
