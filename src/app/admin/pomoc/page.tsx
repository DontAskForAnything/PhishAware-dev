  ...
  return (
    <main className=" px-6 pb-6 gap-1 flex flex-col">
      ...
      <div className="bg-white rounded-lg shadow p-6 mb-6">
        <h2 className="text-2xl font-bold mb-4">FAQ dla administratorów</h2>
      ...
      <div className="bg-[#378075] text-white rounded-lg shadow p-6">
        <div className="flex items-start">
          <div className="flex-1">
            ...
            <p className="mb-4">
              Nasz dedykowany zespół wsparcia administratorów jest dostępny
              24/7. Skontaktuj się z nami!
            </p>
            <button
